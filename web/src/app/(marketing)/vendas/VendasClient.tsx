  ...
  >
    <div className="relative">
      ...
      <motion.a
        ...
        className="relative flex items-center justify-center w-14 h-14 md:w-20 md:h-20 bg-linear-to-tr from-[#25D366] to-[#22d3ee] rounded-full shadow-[0_0_30px_rgba(37,211,102,0.5)] border-2 border-white/20"
      >
...
const AnimatedGrid = () => (
  <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
    <motion.div 
      ...
      className="absolute inset-0 bg-[radial-gradient(#8b5cf6_1px,transparent_1px)] bg-size-[40px_40px] opacity-[0.05]" 
    />
...
const PlanCard = ({ plan }: { plan: Plan }) => (
  ...
  >
    ...
    <a 
      ...
      target="_blank"
      className={`mt-10 py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all text-center block ${plan.featured ? 'bg-black text-white hover:bg-emerald-600 shadow-xl' : 'bg-linear-to-r from-[#8b5cf6] to-[#ec4899] text-white shadow-xl'}`}>
...
const SiteProxPage = () => {
  ...
  return (
    <main className={`min-h-screen bg-[#0a0a0f] text-white selection:bg-[#ec4899]/30 overflow-x-hidden ${inter.className}`}>
      
      <AnimatedGrid />
      <WhatsAppButton />

      {/* --- URGENCY BANNER --- */}
      <div className="relative z-60 bg-linear-to-r from-[#8b5cf6] to-[#ec4899] py-3 text-center">
         <motion.p 
           ...
           <div className="max-w-6xl mx-auto space-y-10">
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="relative inline-block text-transparent bg-clip-text bg-linear-to-r from-[#8b5cf6] via-[#ec4899] to-[#22d3ee] bg-size-[200%_auto] animate-gradient-flow drop-shadow-[0_0_15px_rgba(236,72,153,0.3)]">
                    LUCRO DIGITAL.
                  </span>
                </motion.h1>
                <FadeIn delay={0.4}>
           ...
           <FadeIn delay={0.8}>
              <div className="flex justify-center mt-12">
                 <a 
                   ...
                   target="_blank"
                   className="group relative overflow-hidden bg-linear-to-r from-[#8b5cf6] to-[#ec4899] px-20 py-7 rounded-2xl font-black text-sm uppercase tracking-widest shadow-[0_0_50px_rgba(139,92,246,0.6)] active:scale-95 transition-all flex items-center justify-center min-w-[320px]"
                 >
      ...
      <section className="py-40 z-10 relative">
         <div className="container mx-auto px-6">
            <FadeIn>
               <div className="bg-linear-to-br from-red-600/10 to-transparent border border-red-500/20 rounded-[2rem] md:rounded-[4rem] p-8 md:p-16 relative overflow-hidden">
      ...
      <section className="py-20 z-10 relative">
        <div className="container mx-auto px-6">
           <FadeIn>
              <div className="relative p-1 bg-linear-to-r from-emerald-500/20 via-cyan-500/20 to-emerald-500/20 rounded-[3rem] md:rounded-[5rem]">
                    ...
                    <div className="relative space-y-16">
                       <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                          ...
                          <div className="flex flex-col gap-1 text-center md:text-left">
                             <h2 className={`text-4xl md:text-5xl lg:text-7xl font-black tracking-tighter uppercase italic leading-none ${sora.className}`}>
                             ...
                             <div className="pt-10 mt-10 border-t border-white/5 space-y-5">
                                ...
                                <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
                                   <motion.div 
                                      ...
                                      className="h-full bg-linear-to-r from-emerald-500 via-cyan-500 to-emerald-500 bg-size-[200%_auto] animate-gradient-flow" 
                                   />
                                </div>
                             </div>
                          </div>
      ...
      <section className="relative py-60 z-10 overflow-hidden bg-[#05050a]">
         <div className="absolute inset-x-0 h-px bg-linear-to-r from-transparent via-[#8b5cf6]/50 to-transparent top-0" />
         <div className="container mx-auto px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-12">
               <h2 className={`text-5xl md:text-8xl font-black tracking-tight uppercase leading-none text-white ${sora.className}`}>
                  ...
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-white via-cyan-400 to-white/50 bg-size-[200%_auto] animate-gradient-flow">
                     NÓS SOMOS A ORDEM.
                  </span>
               </h2>
